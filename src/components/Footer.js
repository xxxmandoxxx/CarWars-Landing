    ...
    return (
        <div className="footer">
            ...
            <div className="footer-text">
                ...
                to our <a className="txLink no-style" href="https://www.ethergames.com.au/privacypolicy" target="_blank" rel="noopener noreferrer">privacy policy.</a> and <Link to="/terms" className="txLink">Terms of Use</Link>. We won't do anything shady with your 
            ...
            <Link to="/terms" className="txLink">Terms of Use</Link>
