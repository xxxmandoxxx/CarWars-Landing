...
export const PRESALEDETAILSTEXT = <div><p>In the presale you will buy a package which contains 3 blueprints. Each of these blueprints carry a special mark which will never be seen again. Once the factory opens, you will be able to build your car based on your special pre-sale blueprints.</p>
